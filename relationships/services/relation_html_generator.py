...
.graph-card {{ position:relative; width:100%; min-height:760px; background:rgba(255,250,242,.78); border:1px solid rgba(94,72,45,.14); border-radius:32px; overflow:auto; box-shadow:var(--shadow); }}
